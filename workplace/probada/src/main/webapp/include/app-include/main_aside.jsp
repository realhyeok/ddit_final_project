...
<%@ page trimDirectiveWhitespaces="true" %>
 ...
 <!-- sidebar menu -->
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="<%=request.getContextPath()%>/app/my-work"><i class="fa fa-edit"></i> 내 작업 </a>
                  </li>
                  <li><a href="<%=request.getContextPath()%>/app/project"><i class="fa fa-desktop"></i> 프로젝트</a>
                  </li>
                  <li><a><i class="fa fa-group"></i> 콜라보</a>
                  </li>
                  <li><a><i class="fa fa-video-camera"></i> 온라인 회의</a>
                  </li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="로그아웃" href="<%=request.getContextPath()%>/home/index">
                    ...
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl open" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-306px, 64px, 0px);">
                        ...
                        <div class="kt-grid-nav kt-grid-nav--skin-light">
                            <div class="kt-grid-nav__row">
                                ...
                                <a href="<%=request.getContextPath() %>/app/my-work/issueRegistForm	" class="kt-grid-nav__item">
                                    <span class="kt-grid-nav__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--info kt-svg-icon--lg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                            ...
                            <div class="kt-grid-nav__row">
                                <a href="<%=request.getContextPath() %>/app/my-work" class="kt-grid-nav__item">
                                    <span class="kt-grid-nav__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--info kt-svg-icon--lg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <a href="<%=request.getContextPath() %>/app/my-work/mailRegistForm" class="kt-grid-nav__item">
                                    <span class="kt-grid-nav__icon">
