<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
      ...
      <div class="row">
        <!-- 왼쪽 컬럼 시작 -->
        <div class="col-sm-8" style="border-right: 1px solid #e5e5e5;">
          <section class="panel">
            <div class="x_title">
                ...
                <div class="project-detail-body">
                  ...
                  <div class="project-detail-body project-notice">
                    <div class="x_panel">
                      ...
                      <!-- <div class="x_title">
                        <h5 class="title">
                          <span>잘못했습니다 잘 하겠습니다</span>
                        </h5>
                        <div class="clearfix"></div>
                      </div>
                      <div class="project-detail-body project-notice-content">
                        &nbsp;"국민 여러분의 엄중한 질책, 가슴깊이 뉘우치고
                        있다"며 "그동안의 잘못을 고치고 국민여러분이 원하시는
                        본서와 대리점간의 평등한 상생의 관계를 정립하는 것이
                        반성의 자세"라고 말했다. 다만 남양유업은
                        피해대리점협의회와의 협상에 진전이 없는 상태를 보이고
                        있다. 남양유업의 피해도 점차 커지고 있다. 대형마트와
                        편의점에서 남양유업 우유, 커피제품의 매출은 7~50%까지
                        떨어진 것으로 나타났다. 남양유업은 매출 부진으로 올
                        2분기 영업이익이 적자를 기록할 것으로 내다보고 있다.
                        업계 안팎에서는 "소비자들의 불매운동과 함께 유통업체들도
                        남양유업 제품의 행사 진행을 꺼려하면서 매출에 타격을
                        받고 있다"며 "갑을 문화 개선. 넘어야 할 산은 아직
                        높다"고 말했다. 현재 남양유업측과 피해대리점주협의회는
                        협상안을 놓고 양측의 주장은 엇갈리고 있다. 교섭 파기를
                        선언한 협의회 측은 남양유업이 ′밀어내기 근절′에 대한
                        의지가 없다는 점을 제기했다. 협의회는 매출목표 강제
                        할당제 폐지 등 구체적인 밀어내기 근절 방안 마련을
                        요구했으나 남양유업이 이를 받아들이지 않았다고 주장했다.
                        남양유업이 진정성 있는 방안을 제시할 때까지 대화를
                        재개하지 않겠다는 입장이다. 피해대리점주 측은 5년간
                        대리점 매출액의 20%를 보상해줄 것을 요구하고 있다. 이
                        경우, 금액은 7000억원에 달하는 것으로 알려졌다. 남양유업
                        측은 보상처리기구를 설치해 대리점 매출액 중 피해를 본
                        부분을 전액 보상하는 방안을 제시한 상태다.
                      </div>
                    </div> -->
                    <!-- 프로젝트 공지사항 예시 끝 -->
                    ...
                    <div
                      class="btn create-btn project-bg-btn"
                      data-toggle="modal"
                      data-target="#project-notice-regist"
                    >
                      <svg
                  ...
                  <ul class="list-inline" style="display: inline-flex">
                    ...
                    <li class="project-member nav-item dropdown open">
                      ...
                      <a href="javascript:;"
                          ...
                          aria-expanded="false" >
                        <img src="/webapp/resources/asserts/images/img.jpg"
                             class="img-circle"
                             alt="Avatar"
                        />
                      </a>
                      <div class="dropdown-menu dropdown-membermenu pull-right"
                           ...
                           <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#project-member-modify"> 권한부여</a>
                           <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#project-member-delete"> <span class="text-danger">제명</span> </a>
                      </div>
                    ...
                    <li class="project-member nav-item dropdown open">
                      ...
                      <span>SpearWaterDA</span>
                    </li>
                    <!-- 구성원 단위 끝 -->
                    <!-- 구성원 더보기 버튼 시작 -->
                    <li class="project-member d-flex align-items-center mr-3">
                        <a href="../project/project-member-list.html">
              ...
              <form>
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="notice_title_input">공지사항 제목</label>
                    <input
                      type="text"
                      class="form-control"
          ...
          <div class="modal-body">
            <div class="x_content">
              ...
              <form>
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="project-name-for-modify">프로젝트명</label>
                    <input
                      type="text"
                      class="form-control"
                      id="project-name-for-modify"
                      value="남양(주) 사이트 유지보수"
                    />
                  </div>
                  <!-- select -->
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      class="form-control"
                      rows="10"
                    > 주식회사 남양의 사이트 유지보수를 진행하는 프로젝트 입니다. 프론트엔드와 백엔드 각각 3명씩 구성되어 있으며, 2022년 2월까지 프로젝트 마감 예정입니다. 모르는게 있으면 서로 물어보며 진행하는 팀 분위기를 만들어 갑니다.
                  </textarea>
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      class="form-control"
                      rows="10"
                      placeholder="제명 사유를 적어주세요."
                    ></textarea>
                  </div>
                  <!-- textarea -->
                  <div class="form-group">
                    <label for="project-member-delete">확인을 위해 "<strong class="text-danger">프로젝트 탈퇴</strong>" 를 입력해주세요.</label>
                    <input
                      type="text"
                      class="form-control"
