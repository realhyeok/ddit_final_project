...
<div class="right_col" role="main">
  ...
  <div class="x_panel">
    <div class="x_title">
      <h2><i class="fa fa-edit"></i> 내 작업 <small>* 커스터마이징 해주세요.</small></h2>
    ...
    <div class="x_content">
      <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="mail-tab" data-toggle="tab" href="#mail" role="tab" aria-controls="mail" aria-selected="false">메일</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          <%@ include file="/WEB-INF/views/web-app/my-work/my-dashboard.jsp" %>
        </div>
        <div class="tab-pane fade" id="issue" role="tabpanel" aria-labelledby="issue-tab">
          <%@ include file="/WEB-INF/views/web-app/my-work/my-issue.jsp" %>
        </div>
        <div class="tab-pane fade" id="request" role="tabpanel" aria-labelledby="request-tab">
          <%@ include file="/WEB-INF/views/web-app/my-work/my-request.jsp" %>
        </div>
        <div class="tab-pane fade" id="mail" role="tabpanel" aria-labelledby="mail-tab">
          <%@ include file="/WEB-INF/views/web-app/my-work/my-mail.jsp" %>
        </div>  
        <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
          <%@ include file="/WEB-INF/views/web-app/my-work/my-history.jsp" %>
        </div>  
      </div>
    </div>
  </div>
