        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<%=request.getContextPath() %>/app/index" class="site_title"><img src="https://img.icons8.com/ios-filled/25/3598db/lighthouse.png"/> <span> <small>prodaba</small> </span></a>
            </div>
