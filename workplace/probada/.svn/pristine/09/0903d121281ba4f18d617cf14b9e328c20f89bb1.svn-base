...
<div class="cont">
  <div class="form sign-in">
    ...
    <a href="#"><p class="forgot-pass">비밀번호를 잊으셨나요?</p></a>
  ...
  <div class="sub-cont">
    <div class="img">
        <div class="img__text m--up">
          <h2>처음이신가요?</h2>
          <p>probada를 통해 쉽고 간편하게 프로젝트를 만들어보세요!</p>
        </div>
    ...
    <div class="form sign-up">
      ...
      <button type="button" class="submit" onclick="location.href='<%=request.getContextPath()%>/home/login-verify'">회원가입</button>
