...
<table class="table table-striped table-hover jambo_table bulk_action" style="text-align: center;">
	<thead>
		<tr>
			...
			<th style="width:150px;">삭제날짜</th>
		</tr>
	</thead>
	<tbody>
		<tr class="even pointer">
			<td><input class="trashCheck" type="checkbox"></td>											
...
<button type="button" class="btn btn-sm btn-dark float-left">영구삭제</button>
<button type="button" class="btn btn-sm btn-dark float-left">복구</button>
