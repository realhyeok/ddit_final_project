...
<div class="x_content row">
	...
	<div class="col-md-6 col-sm-6">
		<div class="x_panel m-0" style="min-height:310px; max-height:310px;">
			<div class="x_title">
				<h2>최근 업무</h2>
	...
	<div class="col-md-6 col-sm-6">
		<div class="x_panel_origin rounded rounded-3" style="min-height:310px; max-height:310px;">
			<div class="x_title">
				<h2>최근 이슈</h2>
	...
	<div class="col-md-6 col-sm-6">
		<div class="x_panel_origin" style="min-height:310px; max-height:310px;">
			<div class="x_title">
				<h2>
					최근 메일
				</h2>
