				...
				<div class="mail_heading row">
					<div class="col-md-8">
						<div class="btn-group">
							...
							<button type="button" class="btn btn-sm btn-dark btn-append" onclick="confirm('삭제 하시겠습니까?');"><i class="fa fa-times-circle-o"></i>&nbsp;&nbsp;삭제</button>	
						</div>
					</div>
					<div class="col-md-4 text-right">
						<p class="date"> 2022-01-01 22:07:07</p>
					</div>
					<div class="col-md-12">
...
<table class="table table-striped table-hover jambo_table bulk_action" style="text-align: center;">
	...
	<tbody>
		<tr class="even pointer">
			<td><input class="sendCheck" type="checkbox"></td>											
