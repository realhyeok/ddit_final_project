...
<div class="right_col" role="main">
	...
	<div class="x_panel">
		<div class="x_content">
			<!-- 제목 시작 -->
			<div class="x_title">
				<h2><i class="glyphicon glyphicon-exclamation-sign"></i>&nbsp;&nbsp;&nbsp;이슈 등록</h2>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<label>이슈 내용 :</label>
					<textarea id="content" name="content" class="form-control form-control-sm" placeholder="내용을 입력하세요." style="height:120px;display:none;"></textarea>
				</div>
			</div>
