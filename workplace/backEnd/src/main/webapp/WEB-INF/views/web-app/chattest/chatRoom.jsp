...
window.onload = function(){
	    	...
	    	var temp ="";
	    		...
	    		for(var i=0 in arg){  
	    			...
	    			if(arg[i].userId=="${userVO.userId}"){
	    	        	   ...
	    	        	   temp+='<div class="incoming_msg_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>';
	...
	//메시지 보내기 함수 
  	function onMessage(evt) {
           ...
           console.log("이걸 append 시켜 줘야함 userId=>"+receive[0]+" 닉네임: "+receive[1]+" 메시지:"+receive[2]+"날짜 : "+receive[3]);
...
<%-- 
  if(receive[0]=="${userVO.userId}"){
        	   ...
        	   temp+='<div class="received_withd_msg">';
        	   temp+='<p>'+receive[2]+'</p>';
        	   temp+='<span class="time_date"> 11:01 AM    |    June 9</span>';
        	   temp+='</div>';
        	   temp+='</div>';
        	   temp+='</div>';
