...
$(document).ready(function () {
	var dataBase = [
		  {
		    "IssueNo": 1,
		    "projectName": "AA프로젝트",
		    "IssueName": "<a href='/issueDetail' style='color:black;'>자바스크립트가 안되요</a>",
		    "IssueImportant":"높음",
		    "MileName": "프로젝트 화면 검수",
    ...
    $("#myIssue").kendoGrid({
        ...
        groupable: true,
        toolbar: [
        	{ template: "<button class='btn btn-sm btn-dark' type='button' onclick=\"location.href='/app/myWork/issueRegistForm';\">등록</button>" }
        	,"search","excel", "pdf" ],
        columns: [{
        	field: "projectName",
        	title: "프로젝트명"
