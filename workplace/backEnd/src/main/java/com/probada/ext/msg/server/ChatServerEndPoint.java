 ...
 * @author 이영지(슈퍼개발자K3)
 */
package com.probada.ext.msg.server;
...
import com.probada.ext.msg.server.config.ChatServerAppConfig;
import com.probada.ext.msg.server.model.ChatMessage;
import com.probada.ext.msg.server.model.Message;
import com.probada.ext.msg.server.model.UsersMessage;
import com.probada.ext.msg.server.model.decoder.MessageDecoder;
import com.probada.ext.msg.server.model.encoder.MessageEncoder;


//자동으로 웹 소켓을 생성 , 누군가 들어오면 append 나가면 뺴주고            seok
//end point를 같이 맞추어 보면 
//random 룸 id를 
